    ...
    private void insertData() {
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Long recinsert = sqLiteDatabase.insert(BARTABLE,null,cv);
                if (recinsert != null){
                    Toast.makeText(Bar.this, "Inserted successfully", Toast.LENGTH_SHORT).show();
        ...
        display.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.barActivity, new BarFragment()).commit();
            }
        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sqLiteDatabase = dBmain.getWritableDatabase();
                long recedit = sqLiteDatabase.update(BARTABLE, cv, "id=" +id, null);
                if (recedit != -1){
                    Toast.makeText(Bar.this, "Update successful", Toast.LENGTH_SHORT).show();
