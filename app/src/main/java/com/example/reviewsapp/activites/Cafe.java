    ...
    private void insertData() {
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Long recinsert = sqLiteDatabase.insert(CAFETABLE,null,cv);
                if (recinsert != null){
                    Toast.makeText(Cafe.this, "Inserted successfully", Toast.LENGTH_SHORT).show();
        ...
        display.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.cafeActivity, new CafeFragment()).commit();
            }
        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sqLiteDatabase = dBmain.getWritableDatabase();
                long recedit = sqLiteDatabase.update(CAFETABLE, cv, "id=" +id, null);
                if (recedit != -1){
                    Toast.makeText(Cafe.this, "Update successful", Toast.LENGTH_SHORT).show();
